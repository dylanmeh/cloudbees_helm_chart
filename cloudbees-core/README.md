...
| Agents.Image.dockerImage | string | `"cloudbees/cloudbees-core-agent:2.303.1.6"` | Used to override the default docker image used for agents |
...
| Hibernation.Image.dockerImage | string | `"cloudbees/managed-master-hibernation-monitor:247.c5dfce00a179"` | Used to override the default docker image |
...
| Master.Image.dockerImage | string | `"cloudbees/cloudbees-core-mm:2.303.1.6"` | Used to override the default docker image |
...
| OperationsCenter.Image.dockerImage | string | `"cloudbees/cloudbees-cloud-core-oc:2.303.1.6"` | Container image to use for Operations Center |
